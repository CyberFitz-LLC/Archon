...
from ..services.provider_discovery_service import ModelSpec, ProviderStatus, provider_discovery_service
...
async def get_model_specs(model_id: str, provider: str | None = None) -> ModelSpecResponse:
...
def _get_embedding_dimensions(model_name: str) -> int | None:
...
def _estimate_model_size(model_info: dict[str, Any]) -> float | None:
